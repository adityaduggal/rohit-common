...
import frappe
from .sales_invoice import check_validated_gstin, normalize_place_of_supply
...
def update_fields(doc,method):
	...
	doc.place_of_supply = normalize_place_of_supply(frappe.db.get_value("Purchase Taxes and Charges Template", doc.taxes_and_charges, "state"))
